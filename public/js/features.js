(() => {
      ...
      934: function (t, e, n) {
        ...
        t.exports = (function () {
          ...
          function un(n, r, o) {
            ...
            if (ot())
              return (
                (y = E), r ? a && v(r, nn, [f(), m ? [] : void 0, y]) : f(), E
              );
            var _ = new qn(ut, f, E, { lazy: !0 });
            _.noRecurse = !r;
            var b = m ? [] : cn;
            return (
              (_.run = function () {
          ...
          var On = Sn("beforeMount"),
            ...
            Un = Object.freeze({
              ...
              computed: function (t, e) {
                ...
                var i = ot() ? null : new qn(ut, n, E, { lazy: !0 }),
                  a = {
                    effect: i,
                    get value() {
                      return i
          ...
          var Vn = 0,
            ...
            Jn = { enumerable: !0, configurable: !0, get: E, set: E };
          function Kn(t, e, n) {
            (Jn.get = function () {
              return this[e][n];
            }),
            ...
            n.computed &&
              (function (t, e) {
                ...
                for (var o in e) {
                  var i = e[o],
                    a = s(i) ? i : i.get;
                  r || (n[o] = new qn(t, a || E, E, Gn)), o in t || Xn(t, o, i);
                }
              })(t, n.computed),
              n.watch &&
                n.watch !== et &&
                  ...
                  ((n = (function (t, e) {
                    ...
                    if (n && !o(t.owners)) {
                      ...
                      var f = function (t) {
                        ...
                        p = L(function (n) {
                          (t.resolved = Ee(n, e)), s ? (a.length = 0) : f(!0);
                        }),
                        v = L(function (e) {
          ...
          function xo(t, e) {
            ...
            if (
              ...
              o(c) && (s = Jr(s, Kr(c))),
                s !== n._prevClass &&
                  (n.setAttribute("class", s), (n._prevclassName = s));
            }
          }
          var $o,
            Co,
          ...
          var ya,
            ...
            xa = {
              ...
              transformNode: function (t, e) {
                ...
                var n = Ho(t, "class");
                n &&
                  (t.staticclassName = JSON.stringify(
                    n.replace(/\s+/g, " ").trim()
                  ));
                var r = Bo(t, "class", !1);
                r && (t.classBinding = r);
            ...
            Aa =
              /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+?\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
            ja = "[a-zA-Z_][\\-\\.0-9_a-zA-Z".concat(H.source, "]*"),
            Ea = "((?:".concat(ja, "\\:)?").concat(ja, ")"),
            Na = new RegExp("^<".concat(Ea)),
            Pa = /^\s*(\/?)>/,
            Ra = new RegExp("^<\\/".concat(Ea, "[^>]*>")),
            Da = /^<!DOCTYPE [^>]+>/i,
            La = /^<!\--/,
            Ma = /^<!\[/,
  ...
  (n.g = (function () {
    ...
    new Vue({
      ...
      data: {
        feature: {
          title: "Select Feature To See Example",
          body: "Please click on a feature above to see an example of what it would look like in the log.",
        },
      },
      methods: {
        loadFeature: function (t) {
          "date" === t
            ? ((this.feature.title = "Date/Time"),
              (this.feature.body = "2022-11-01 11:50:13 UTC+3"))
            : "ip" === t
            ? ((this.feature.title = "IP Address"),
              (this.feature.body = "172.67.68.246"))
            : "country" === t
            ? ((this.feature.title = "Country"), (this.feature.body = "Canada"))
            : "city" === t
            ? ((this.feature.title = "City"), (this.feature.body = "Toronto"))
            : "charging" === t
            ? ((this.feature.title = "Charging"), (this.feature.body = "Yes"))
            : "battery" === t
            ? ((this.feature.title = "Battery"), (this.feature.body = "87%"))
            : "orientation" === t
            ? ((this.feature.title = "Orientation"),
              (this.feature.body = "landscape-primary"))
            : "connection" === t
            ? ((this.feature.title = "Connection Type"),
              (this.feature.body = "4G LTE"))
            : "timezone" === t
            ? ((this.feature.title = "Timezone"),
              (this.feature.body = "America/New_York EDT"))
            : "language" === t
            ? ((this.feature.title = "Language"), (this.feature.body = "en-US"))
            : "incognito" === t
            ? ((this.feature.title = "Incognito/Private Window"),
              (this.feature.body = "Yes"))
            : "ad" === t
            ? ((this.feature.title = "Ad Blocker"), (this.feature.body = "Yes"))
            : "screen" === t
            ? ((this.feature.title = "Screen Size"),
              (this.feature.body = "1920 x 1080"))
            : "localIp" === t
            ? ((this.feature.title = "Local IP"),
              (this.feature.body = "192.168.1.123"))
            : "browser" === t
            ? ((this.feature.title = "Browser"),
              (this.feature.body = "Chrome (106.0.0.0)"))
            : "os" === t
            ? ((this.feature.title = "Operating System"),
              (this.feature.body = "Windows 10 x64"))
            : "device" === t
            ? ((this.feature.title = "Device"),
              (this.feature.body = "Google Pixel 4a"))
            : "gpu" === t
            ? ((this.feature.title = "GPU"),
              (this.feature.body = "NVIDIA GeForce RTX 2070 SUPER"))
            : "botName" === t
            ? ((this.feature.title = "Bot Name"),
              (this.feature.body = "Facebook Metadata"))
            : "ua" === t
            ? ((this.feature.title = "User Agent"),
              (this.feature.body =
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36"))
            : "referring" === t
            ? ((this.feature.title = "Referring URL"),
              (this.feature.body = "https://example.com/forum.php?post=123"))
            : "hostName" === t
            ? ((this.feature.title = "Host Name"),
              (this.feature.body = "2.sub-174-209-100.example.com"))
            : "isp" === t
            ? ((this.feature.title = "Internet Service Provider"),
              (this.feature.body = "Vodafone"))
            : "vpn" === t
            ? ((this.feature.title = "VPN/Proxy Detection"),
              (this.feature.body = "Yes"))
            : "tor" === t
            ? ((this.feature.title = "Tor Detection"),
              (this.feature.body = "No"))
            : "vm" === t &&
              ((this.feature.title = "Virtual Machine Detection"),
              (this.feature.body = "Yes"));
        },
      },
    });
