    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Register - Grabify IP Logger &amp; URL Shortener"
        />
        <meta
          property="og:title"
          content="Register - Grabify IP Logger &amp; URL Shortener"
        ...
        <meta
          ...
          content="Register - Grabify IP Logger URL Shortener - Log and Track IP addresses"
        />
        <meta property="og:url" content="https://grabify.xyz/register" />
        <title>Register - Grabify IP Logger &amp; URL Shortener</title>
        <link rel="canonical" href="https://grabify.xyz/register" />
          ...
          <section className="landing-hero">
            <div className="hero-body container has-text-centered">
              ...
              <h3 className="subtitle is-5 has-text-white-ter">
                Create a shiny new Grabify account.
              </h3>
            </div>
          ...
          <section className="section container">
            <div className="columns is-centered has-text-centered">
              <div className="column is-half">
                ...
                <form id="register" onSubmit={handleSubmit}>
                  ...
                  <div className="field">
                    <div className="control">
                      <label className="checkbox">
                        <input type="checkbox" id="tos" name="tos" required /> I
                        accept the{" "}
                        <a
                          target="_blank"
                          style={{ color: "#233140" }}
                          href="https://grabify.xyz/tos"
                        >
                          Terms of Service
                        </a>{" "}
                        and the{" "}
                        <a
                          target="_blank"
                          style={{ color: "#233140" }}
                          href="https://grabify.xyz/privacy"
                        >
                          Privacy Policy
                        </a>
                      </label>
                  ...
                  <div className="form-actions">
                    {/*<button
                      ...
                      type="submit"
                      className="button is-primary g-recaptcha"
                    >
                      Register{" "}
                    </button>*/}
                    <button
                ...
                <a href="https://grabify.xyz/login">Login Here</a>
              </div>
            </div>
          </section>
        </div>
