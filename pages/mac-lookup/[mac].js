...
export default function MACLookupLmao(props) {
  ...
  useEffect(() => {
    fetch(`/api/mac-lookup?mac=${mac}`)
      .then((r) => r.json())
      .then((json) => {
        //console.log(json);
        return setMACInfo(json);
      })
      .catch((e) => {
        //console.log(e);
        return setMACInfo("{}");
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:url" content="https://grabify.xyz/mac-lookup/x" />
        <title>MAC Address Lookup - Grabify IP Logger &amp; URL Shortener</title>
        <link rel="canonical" href="https://grabify.xyz/mac-lookup/x" />
          ...
          <section className="section container">
            ...
            {MACInfo === "{}" && (
              <div className="notification is-warning">
                <ul>
                  <li>
                    Sorry could not find any information on the MAC address: "
                    {mac}". Please check it is correct and try again.
                  </li>
                </ul>
              </div>
            )}
            <div className="field">
              ...
              <div className="control">
                <input
                  ...
                  id="mac"
                  name="mac"
                  placeholder="Please enter aa MAC address"
                  value={mac}
              ...
              <div className="table-responsive">
                <table className="table table-bordered is-striped is-bordered is-fullwidth">
                  <tbody>
                    <tr>
                      <th>
                        <i className="fa fa-link"></i> MAC Address
                      </th>
                      <td>
                        <p>{props.mac}</p>
                      </td>
                    ...
                    <tr>
                      <th>
                        <i className="fa fa-earth-americas"></i> Country
                      </th>
                      <td>
                        <p>{MACInfo["country"]}</p>
                      </td>
                    ...
                    <tr>
                      <th>
                        <i className="fa-solid fa-outdent"></i> MAC Prefix/OUI
                      </th>
                      <td>
                        <p>{props.mac.substring(0, 8)}</p>
                      </td>
                    </tr>
                    <tr>
                      <th>
                        <i className="fa-solid fa-backward-step"></i> Block
                        Start
                      </th>
                      <td>
                        <p>
                    ...
                    <tr>
                      <th>
                        <i className="fa-solid fa-forward-step"></i> Block End
                      </th>
                      <td>
                        <p>
                          {insertAfterEveryN(MACInfo["blockEnd"], ":", 2).slice(
                            0,
                            -1
                          )}
                        </p>
